...
public class UpdateAccountJson {
    ...
    public UpdateAccountJson(UpdateAccountForm updateAccountForm) {
        UPDACC = new UpdaccJson(
        updateAccountForm.getCustNumber(), 
    ...
    public String toPrettyString() {
        ...
        output += "Account Number: " + OutputFormatUtils.leadingZeroes(8, accInfo.getCOMM_ACCNO()) + "\n"
                ...
                + "Interest Rate: " + String.format("%.02f", accInfo.getCOMM_INT_RATE()) + "\n"
                + "Overdraft Limit: " + accInfo.getCOMM_OVERDRAFT() + "\n"
                + "Available Balance: " + String.format("%.02f", accInfo.getCOMM_AVAIL_BAL()) + "\n"
                + "Actual Balance: " + String.format("%.02f", accInfo.getCOMM_ACTUAL_BAL()) + "\n"
