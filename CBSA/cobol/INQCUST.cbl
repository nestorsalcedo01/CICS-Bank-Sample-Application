      ...
      * Copyright statement as a literal to go into the load module
       ...
       01 DATA-STORE-TYPE              PIC X.
          88 DATASTORE-TYPE-IMS           VALUE '1'.
          88 DATASTORE-TYPE-DB2           VALUE '2'.
          88 DATASTORE-TYPE-VSAM          VALUE 'V'.

       01 USE-NAMED-COUNTER            PIC X VALUE 'N'.
      ...
      *
                 ...
                 STRING 'P010 - Unknown DATASTORE Type (Other) '
                       DELIMITED BY SIZE,
                 ...
                 DISPLAY 'P010 - ERROR. Unknown datastore type'
                    DATA-STORE-TYPE
      ...
      *
       ...
       RCN010.
      *
      *    Access the CUSTOMER Named Counter Server
      *
           IF USE-NAMED-COUNTER = 'Y'

              MOVE WS-SORT-CODE OF WS-PASSED-DATA TO
                 NCS-CUST-NO-TEST-SORT

              MOVE 0 TO NCS-CUST-NO-INC

              EXEC CICS GET DCOUNTER(NCS-CUST-NO-NAME)
      ...
      *
      *       Check that the read of the NCS was successful,
      *       abend if not.
      *
      ...
      *
                 ...
                 STRING 'RCN010 -WS-CICS-RESP NOT NORMAL IN INQCUST'
                     DELIMITED BY SIZE,
                     'DATA-STORE-TYPE IS ' DELIMITED BY SIZE,
                     'INQCUST - CUSTOMER NCS ' DELIMITED BY SIZE,
                     NCS-CUST-NO-NAME DELIMITED BY SIZE,
                     ' CANNOT BE ACCESSED.' DELIMITED BY SIZE,
                     INTO ABND-FREEFORM
                 END-STRING
                 ...
                 DISPLAY 'INQCUST - CUSTOMER NCS ' NCS-CUST-NO-NAME
      ...
      *READ-CUSTOMER-LAST-AGAIN SECTION.
      *RCLA010.
      *
      *    EVALUATE TRUE
      *       WHEN DATASTORE-TYPE-VSAM
