      ...
      *    be accessing from the data in the Vendor Anchor Table
      *
      ...
      *
           ...
           EVALUATE TRUE
              ...
              WHEN OTHER
                 DISPLAY 'ERROR in CREACC. Unknown datastore type'
                    DATA-STORE-TYPE
      *
      ...
      *
       ...
       WP010.
           ...
           EVALUATE PROCTRAN-FLAG
              ...
              WHEN OTHER
                 DISPLAY 'ERROR in CREACC WP010. Unknown datastore'
                    ' type '
                    DATA-STORE-TYPE
      ...
      *
                 ...
                 STRING 'WP010  - PROCTRAN unknown data store='
                    DELIMITED BY SIZE,
                    PROCTRAN-FLAG DELIMITED BY SIZE,
                    ' EIBRESP=' DELIMITED BY SIZE,
                    ABND-RESPCODE DELIMITED BY SIZE,
                    ' RESP2=' DELIMITED BY SIZE,
                    ABND-RESP2CODE DELIMITED BY SIZE
