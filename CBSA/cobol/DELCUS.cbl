      ...
      * Pull in the SQL COMMAREA
       ...
       01 DATA-STORE-TYPE              PIC X.
          ...
          88 DATASTORE-TYPE-DLI-EXEC      VALUE 'I'.
      ...
      *   03 STORED-NUMBER-OF-ACCOUNTS    PIC S9(8) BINARY.
      *   03 STORED-CUSTOMER-NUMBER       PIC 9(10).
      *   03 STORED-SUCCESS               PIC X.
      *   03 STORED-ACCOUNT-DETAILS OCCURS 20 TIMES.
      *     05 STORED-EYE                    PIC X(4).
      *     05 STORED-CUSTNO                 PIC X(10).
      *     05 STORED-SCODE                  PIC 9(6).
      *     05 STORED-ACCNO                  PIC 9(8).
      *     05 STORED-ACC-TYPE               PIC X(8).
      *     05 STORED-INT-RATE               PIC 9(4)V99.
      *     05 STORED-OPENED                 PIC 9(8).
      *     05 STORED-OVERDRAFT              PIC 9(8).
      *     05 STORED-LAST-STMT-DT           PIC 9(8).
      *     05 STORED-NEXT-STMT-DT           PIC 9(8).
      *     05 STORED-AVAIL-BAL              PIC S9(10)V99.
      *     05 STORED-ACTUAL-BAL             PIC S9(10)V99.
      ...
      *
       ...
       A010.
           ...
           MOVE ACCOUNT-FLAG TO DATA-STORE-TYPE.

      *
      *    Get the accounts that relate to this customer number
      *
           PERFORM GET-ACCOUNTS

           EVALUATE TRUE

              WHEN DATASTORE-TYPE-DB2
      ...
      *
                 ...
                 DISPLAY 'ERROR in DELCUS. Unknown datastore type'
                    DATA-STORE-TYPE
      ...
      *
      *    Determine what kind of CUSTOMER datastore we should
      *    be accessing and delete the associated customer record from
      *    it.
      *
           MOVE CUSTOMER-FLAG TO DATA-STORE-TYPE.

           EVALUATE TRUE
              WHEN DATASTORE-TYPE-VSAM
      ...
      *
                 ...
                 STRING 'A010(4) - Unknown datastore type '
                    DELIMITED BY SIZE,
                    DATA-STORE-TYPE DELIMITED BY SIZE,
      ...
      *
                 ...
                 STRING 'WPC010 - Unknown datastore type '
                    DELIMITED BY SIZE,
                    DATA-STORE-TYPE DELIMITED BY SIZE,
                    ' EIBRESP=' DELIMITED BY SIZE,
                    ABND-RESPCODE DELIMITED BY SIZE,
                 ...
                 DISPLAY 'ERROR in DELCUS WPC010. Unknown datastore'
                    ' type '
                    DATA-STORE-TYPE
