      ...
      *
                 ...
                 STRING 'P010(3) - Unknown datastore type'
                    DELIMITED BY SIZE,
                    DATA-STORE-TYPE
                    DELIMITED BY SIZE,
                    'for CUSTOMER data.'
                 ...
                 DISPLAY 'ERROR in CRECUST. Unknown datastore type'
                    DATA-STORE-TYPE
                    ' for CUSTOMER data.'
      ...
      *
       ...
       RN010.
      *
      *    When something has gone wrong, we need to restore the
      *    Named Counter to its original value.
      *
           IF NAMED-COUNTER-FLAG = 'Y'
              COMPUTE NCS-CUST-NO-VALUE = NCS-CUST-NO-VALUE - 1

              EXEC CICS UPDATE DCOUNTER(NCS-CUST-NO-NAME)
      ...
      *
           ...
           UNTIL WS-CC-CNT > CREDIT-AGENCY-CNT

      *
      *       Use transactions OCR1 - OCR5
      *
              STRING TXN-OVERRIDE DELIMITED BY SIZE,
      ...
      *
                 ...
                 STRING 'W010  - Unknown datastore type='
                    DELIMITED BY SIZE,
                    DATA-STORE-TYPE
                    DELIMITED BY SIZE,
                    '. For PROCTRAN data.'
                 ...
                 DISPLAY 'ERROR in CRECUST WP010. Unknown datastore'
                    ' type '
                    DATA-STORE-TYPE
                    ' For PROCTRAN data.'
