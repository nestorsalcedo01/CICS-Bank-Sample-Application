      ...
      *
                 ...
                 DISPLAY 'ERROR in INQACC. Unknown datastore type'
                    DATA-STORE-TYPE
      ...
      *
                 ...
                 STRING 'RAN010 -Datastore TYPE is '
                    DELIMITED BY SIZE,
                    DATA-STORE-TYPE DELIMITED BY SIZE,
                    '. CUSTOMER NCS ' DELIMITED BY SIZE,
                 ...
                 DISPLAY 'INQACC - CUSTOMER NCS ' NCS-ACC-NO-NAME
      ...
      *
                    ...
                    STRING 'RAN010 -Unexpected DATASTORE Type (Other) '
                       DELIMITED BY SIZE,
                       DATA-STORE-TYPE DELIMITED BY SIZE,
                       ' EIBRESP=' DELIMITED BY SIZE,
                       ABND-RESPCODE DELIMITED BY SIZE,
