//ASMPLTPI JOB ,,CLASS=A,MSGCLASS=H,
//  NOTIFY=&SYSUID,
//  MSGLEVEL=(1,1)
//* TYPRUN=SCAN,
//*
...
//*
//*------------------------------------------------------------------
//* Sample job to assemble a PLTPI table
//*
//*------------------------------------------------------------------
//*
//*
//* Please change @BANK_PREFIX@ to the high level qualifier of your
//* LOADLIB and INSTALL datasets
//*
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD DISP=SHR,DSN=@BANK_PREFIX@.INSTALL(DFHPLTBK)
//LKED     EXEC PGM=IEWL,COND=(7,LT,ASM),PARM='RENT,LIST,XREF'
//SYSLMOD  DD DISP=SHR,DSN=@BANK_PREFIX@.LOADLIB
