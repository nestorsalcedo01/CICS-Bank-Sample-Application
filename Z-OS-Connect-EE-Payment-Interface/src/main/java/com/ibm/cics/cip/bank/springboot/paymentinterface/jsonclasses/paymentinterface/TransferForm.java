...
public class TransferForm {
    ...
    public TransferForm(@NotNull @Size(max = 8) String acctNumber, @NotNull Float amount,
    ...
    public String toString() {
        return "TransferForm [acctNumber=" + acctNumber + ", amount=" + amount + ", organisation=" + organisation + "]";
    }
}
