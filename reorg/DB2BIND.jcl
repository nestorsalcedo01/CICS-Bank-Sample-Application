...
//     DD DISP=SHR,DSN=CBSA.CICSBSA.DBRM(ACCOFFL)
//     DD DISP=SHR,DSN=CBSA.CICSBSA.DBRM(ACCLOAD)
//     DD DISP=SHR,DSN=CBSA.CICSBSA.DBRM(PROOFFL)
//     DD DISP=SHR,DSN=CBSA.CICSBSA.DBRM(PROLOAD)
//SYSPRINT DD  SYSOUT=*
//SYSTSPRT DD  SYSOUT=*
//SYSUDUMP DD  SYSOUT=*
//SYSTSIN DD *
